...
import { addQualificatif, deleteQualificatif, getQualificatifList, updateQualificatif } from "../services/qualificatifService";
...
export function trouverIdQualificatif(qualificatif: Qualificatif, qualificatifListe: Qualificatif[]): number | null {
    if (qualificatif && qualificatifListe ) {
        console.log("troub");
        // Recherche du qualificatif dans la liste
        const qualificatifTrouve = qualificatifListe.find(item =>
            item.minimal === qualificatif.minimal && item.maximal === qualificatif.maximal
        );
...
export const QualificatifContextProvider: React.FC<qualificatifContextProviderProps> = ({ children }) => {
    ...
    const addNewQualificatif = useCallback(async (qualificatif: Qualificatif) => {
    ...
    const modifyQualificatif = useCallback(async (id_qualificatif : number, qualificatif: Qualificatif) => {

        const response = await updateQualificatif( id_qualificatif,qualificatif);
        if(response){
            setQualificatifMinimal('');
            setQualificatifMaximal('');
    ...
    return (
        <QualificatifContext.Provider value={{ updateQualificatifList, qualificatifList,addNewQualificatif,
        qualificatifMaximal, qualificatifMinimal, updateQualificatifMaximal , updateQualificatifMinimal, qualificatifListError,
        addQualificatifError, removeQualificatif, deleteQualificatifError, modifyQualificatifError, modifyQualificatif
        }}>
            {children}
